   ...
   /* public function up()
    {
        Schema::create('usuariosempresas', function (Blueprint $table) {         
            ...
            $table->foreign('empresa')->references('id')->on('empresas')->onUpdate('cascade')->onDelete('cascade');
            ...
            //$table->primary(['usuario']);//Declaracion de la clave conpuesta o primary key de la tabla
            $table->timestamps();
        });
