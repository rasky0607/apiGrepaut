...
class CreateTableReparaciones extends Migration
{
    ...
    public function up()
    {
        Schema::create('reparaciones', function (Blueprint $table) {
            ...
            $table->foreign('matriculaCoche')->references('matricula')->on('coches')->onUpdate('cascade');//Referencia de la clave ajena que se prograga desde la tabla usuarios
